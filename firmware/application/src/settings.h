...
#define SETTINGS_BLE_IDLE_DEFAULT_S 180u
#define SETTINGS_BLE_IDLE_MIN_S      30u
#define SETTINGS_BLE_IDLE_MAX_S    7200u
...
typedef enum {
    ...
    SettingsButtonToggleAutoAdvance = 6U,
