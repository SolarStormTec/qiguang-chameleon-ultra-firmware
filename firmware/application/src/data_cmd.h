...
#define DATA_CMD_GET_ATTESTATION                (1041)
#define DATA_CMD_ATTEST_PROVISION_INIT          (1043)
#define DATA_CMD_ATTEST_PROVISION_SET_CERT      (1044)
#define DATA_CMD_ATTEST_PROVISION_LOCK          (1045)
#define DATA_CMD_GET_SLOT_TABLE                 (1046)
...
#define DATA_CMD_SKY_ACTIVATE_SLOT              (8001)
#define DATA_CMD_SKY_WRITE_SLOT                 (8002)
#define DATA_CMD_SKY_READ_SLOT                  (8003)
#define DATA_CMD_SKY_GET_FDS_STAT               (8004)
#define DATA_CMD_SKY_GET_POWER                  (8005)
#define DATA_CMD_SKY_GET_NFC_STAT               (8006)
#define DATA_CMD_SKY_GET_SLOT_HEALTH            (8007)
#define DATA_CMD_SKY_GET_NFCT_DIAG              (8008)
#define DATA_CMD_SKY_SET_EVENT_MASK             (8010)
#define DATA_CMD_SKY_GET_BLE_IDLE               (8011)
#define DATA_CMD_SKY_SET_BLE_IDLE               (8012)
#define DATA_CMD_SKY_EVT_SLOT_CHANGED           (8901)
#define DATA_CMD_SKY_EVT_TAG_READ               (8902)
#define DATA_CMD_SKY_EVT_BATTERY                (8903)
#define DATA_CMD_SKY_EVT_POWER                  (8904)
